...
Use managed PostgreSQL backups plus periodic verified exports appropriate to the school’s data volume. Before destructive or bulk result operations, take or confirm an important database backup. ImageKit files need their own retention/export plan; a database backup alone does not restore files.
