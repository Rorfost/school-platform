...
| Object storage unavailable | Pause uploads/publishing that need storage; preserve metadata changes only when safe; check ImageKit status, private key, and URL endpoint configuration. |
