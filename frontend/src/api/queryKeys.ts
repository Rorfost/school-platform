export const queryKeys = {
  ...
  notices: (filters?: { page?: number; size?: number }) =>
    ["notices", filters ?? {}] as const,
  materials: (filters?: { page?: number; size?: number }) =>
    ["materials", filters ?? {}] as const,
  downloads: (filters?: { page?: number; size?: number }) =>
    ["downloads", filters ?? {}] as const,
  galleryAlbums: (filters?: { page?: number; size?: number }) =>
    ["gallery", "albums", filters ?? {}] as const,
  galleryAlbumImages: (albumId: string) =>
    ["gallery", "albums", albumId, "images"] as const,
